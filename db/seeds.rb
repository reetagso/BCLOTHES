...
louise_item = Item.create(size: 10, colour: "Multi", occasion: "Casual", category: "Clothes", category_type: "Swimwear", brand: "Other", condition: "Used but good", description: "H&M colourful swimming costume", user_id: louise.id)
...
marie_item_1 = Item.create(size: 14, colour: "Black", occasion: "Party", category: "Clothes", category_type: "Dresses", brand: "Gucci", condition: "Like new", description: "Gucci black and red cocktail dress", user_id: marie.id)
...
marie_item_2 = Item.create(size: 36, colour: "Red", occasion: "Party", category: "Shoes", category_type: "Shoes", brand: "Gucci", condition: "Used but good", description: "Gucci red real leather mid height heels", user_id: marie.id)
...
paula_item = Item.create(size: 40, colour: "Black", occasion: "Formal", category: "Clothes", category_type: "Jacket", brand: "Armani", condition: "Like new", description: "Armani black jacket with front detail", user_id: paula.id)
...
elise_item_1 = Item.create(size: 8, colour: "Green", occasion: "Party", category: "Bag", category_type: "Bags", brand: "Zara", condition: "Past its best", description: "Zara green faux leather cross body", user_id: elise.id)
...
elise_item_2 = Item.create(size: 10, colour: "Black", occasion: "Sport", category: "Clothes", category_type: "Trousers", brand: "Adidas", condition: "Past its best", description: "Adidas black sport trousers", user_id: elise.id)
