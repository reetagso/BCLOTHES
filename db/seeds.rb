...
louise_item = Item.create(size: 10, colour: "Multi", occasion: "Casual", category: "Swimwear", brand: "Other", condition: "Used but good", description: "H&M colourful swimming costume", user_id: louise.id)
...
marie_item_1 = Item.create(size: 14, colour: "Black", occasion: "Party", category: "Dresses", brand: "Gucci", condition: "Like new", description: "Gucci black and red cocktail dress", user_id: marie.id)
...
marie_item_2 = Item.create(size: 36, colour: "Red", occasion: "Party", category: "Shoes", brand: "Gucci", condition: "Used but good", description: "Gucci red real leather mid height heels", user_id: marie.id)
...
paula_item = Item.create(size: 40, colour: "Black", occasion: "Formal", category: "Jacket", brand: "Armani", condition: "Like new", description: "Armani black jacket with front detail", user_id: paula.id)
...
elise_item_1 = Item.create(size: 8, colour: "Green", occasion: "Party", category: "Bags", brand: "Zara", condition: "Past its best", description: "Zara green faux leather cross body", user_id: elise.id)
...
elise_item_2 = Item.create(size: 10, colour: "Black", occasion: "Sport", category: "Trousers", brand: "Adidas", condition: "Past its best", description: "Adidas black sport trousers", user_id: elise.id)
...
emma_item_1 = Item.create(size: 38, colour: "White", occasion: "Sport", category: "Shoes", brand: "Nike", condition: "Used but good", description: "White Nike air force ones", user_id: emma.id)
...
emma_item_2 = Item.create(size: 8, colour: "Multi", occasion: "Summer", category: "Skirts", brand: "Zara", condition: "Used but good", description: "Floaty floral summer dress, loose fit", user_id: emma.id)
...
suggestion_1 = Suggestion.create(request_id: emma_request.id, item_id: marie_item_1.id)
